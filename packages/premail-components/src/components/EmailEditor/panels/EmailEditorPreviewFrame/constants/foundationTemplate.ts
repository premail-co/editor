import { css } from "./foundationCSS";

const contentNodeId = "content-node";
const preheaderTextNodeId = "preheader-text-node";
...
`;
export { template, contentNodeId, preheaderTextNodeId };
